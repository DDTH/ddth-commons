...
public class SpringUtils {
     ...
     * @return
     */
    public static <T> T getBean(ApplicationContext appContext, String id, Class<T> clazz) {
        try {
     ...
     */
    public static <T> Map<String, T> getBeansOfType(ApplicationContext appContext, Class<T> clazz) {
        try {
